...
Socket::Socket(int socket_descriptor): socket_descriptor_(socket_descriptor), last_updated_() {}
...
std::shared_ptr<Request> Socket::readNextRequest() {
    ...
    std::shared_ptr<Request> request = Request::build_request(buffer_.substr(0, break_point));
